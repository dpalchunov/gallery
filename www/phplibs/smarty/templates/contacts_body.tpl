    <div id="wrap">
		...
		<div id="contacts_table">
		    <table border=0>
		      ...
		      <tr  class="empty"><td   rowspan=3  width=100 ><img  src="../images/contacts/phone2.png"/></td><td></td></tr>
		      <tr><td class="info">+7(926)-033-39-31</td></tr>
		      <tr><td id="contacts_call_comment" class="comment">{{{$contacts_call_comment}}}</td></tr>
		      
		      <tr  class="empty"><td rowspan=3 ><a class="container" href="mailto:kristina-8989@mail.ru"><img src="../images/contacts/mail_black1.png"/></a></td><td></td></tr>
