<?php /* Smarty version Smarty-3.1.11, created on 2013-01-02 03:30:42
         compiled from "phplibs\smarty\templates\gallery.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9990503a8076e7fb60-55594644%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b59706399dbc54d7389d7817526720a1e679e151' => 
    array (
      0 => 'phplibs\\smarty\\templates\\gallery.tpl',
      1 => 1357083039,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9990503a8076e7fb60-55594644',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_503a8076ef59b0_11248971',
  'variables' => 
  array (
    'lang' => 0,
    'no_results' => 0,
...
<?php if ($_valid && !is_callable('content_503a8076ef59b0_11248971')) {function content_503a8076ef59b0_11248971($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ru-RU">
    <head>
	<meta charset="utf-8"/>
...
function rewritePageByPageNum(pageNum) {
    ...
    $.post("getPicturePage.php" ,allParamsString,
	 ...
	 function(data){  
		...
		$("#sketches_table_body").html("<tr><td colspan=3 padding=25px>&nbsp &nbsp &nbsp &nbsp &nbsp<?php echo $_smarty_tpl->tpl_vars['no_results']->value;?>
</td></tr>");		
		showFooter();		
	    }
	 }
...
function smallImageMouseOverHandler() {
    ...
    detailsShow = window.setTimeout(function () {closeAllAnnotations();},3000);
    ...
    rateShow = window.setTimeout(function () {closeAllAnnotations();},3000);     
}
...
<script type="text/javascript">
	...
	$(':checkbox',this).each(function(){this.checked = !this.checked;});
	...
	.find(':checkbox')
	.each(function(index,element) {element.checked = false; setFakeCheckboxStyleTurnedOff(element);});
...
//						    console.info('setAllClassificatorsStyle ' + currentTime);						    
	...
	.find('[type=checkbox]')
	.each(function(index,element){ if (element.checked) {allCheckboxesUnchecked = false }});
...
<!-- Конец. Скрипт отвечающий за клин на header Kristina Strunkova-->
	...
	<div class="panel">
	    ...
	    <div id="classificators"><?php echo $_smarty_tpl->tpl_vars['classificators']->value;?>
</div>
	</div>	
    </body>
</html><?php }} ?>