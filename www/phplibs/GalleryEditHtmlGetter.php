                    ...
                    <div class=\"field_editor_div\">
                        <form id=\"form_{$file_base}\" class=\"field_editor_form\" action=\"gallery_update_pic.php\">
                            <div class=\"rus_desc_div\">
                                ...
                                <textarea name=\"rus_desc\" class=\"rus_desc_input field_editor_input\" hash_holder=\"area_{$file_base}\"></textarea>
                            </div>
                            <div class=\"eng_desc_div\">
                                <label class=\"field_editor_label\">Desc in english </label>
                                <textarea name=\"eng_desc\" class=\"eng_desc_input field_editor_input\" hash_holder=\"area_{$file_base}\" ></textarea>
                            </div>
                            <div class=\"rate\">
                                ...
                                <div class=\"rate_radio_group\">
                                    ...
                                    <input name=\"rate\" class=\"rate_input field_editor_input\"  name=\"rate_input\" type=\"radio\" value=\"1\" hash_holder=\"area_{$file_base}\" ></input>
                                    <label class=\"rate_radio_label_label\">2 </label>
                                    <input name=\"rate\" class=\"rate_input field_editor_input\"  name=\"rate_input\" type=\"radio\" value=\"2\" hash_holder=\"area_{$file_base}\" ></input>
                                    <label class=\"rate_radio_label_label\">3 </label>
                                    <input name=\"rate\" class=\"rate_input field_editor_input\"  name=\"rate_input\" type=\"radio\" value=\"3\" hash_holder=\"area_{$file_base}\" ></input>
                                </div>
                            </div>
                            <div class=\"position\">
                                <label class=\"field_editor_label\">Position </label>
                                <input name=\"position\" class=\"position_input field_editor_input\"  type=\"text\" hash_holder=\"area_{$file_base}\" ></input>
                            </div>
